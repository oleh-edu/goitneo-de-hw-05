...
class KafkaSensorAlertConsumer:
    ...
    def _configure_consumer(self):
        ...
        return KafkaConsumer(
            self.topic_name_temperature_alerts,
            self.topic_name_humidity_alerts,
    ...
    def listen(self):
        ...
        logging.info(f"Waiting for notifications from the topics: [{self.topic_name_temperature_alerts}] and [{self.topic_name_humidity_alerts}]...")
        try:
