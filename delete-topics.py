...
def delete_topics(topic_prefix):
    ...
    topic_name_temperature_alerts = f'{topic_prefix}_temperature_alerts'
    topic_name_humidity_alerts = f'{topic_prefix}_humidity_alerts'

    topics_to_delete = [
        topic_name_sensors,
        topic_name_temperature_alerts,
        topic_name_humidity_alerts
    ]
